...
type Filter struct {
	...
	MinTam      *Memory `protobuf:"bytes,4,opt,name=min_tam,json=minTam,proto3" json:"min_tam,omitempty"`
}
...
func (x *Filter) GetMinTam() *Memory {
	if x != nil {
		return x.MinTam
	}
	return nil
...
var file_filter_proto_rawDesc = []byte{
	...
	0x47, 0x68, 0x7a, 0x12, 0x23, 0x0a, 0x07, 0x6d, 0x69, 0x6e, 0x5f, 0x74, 0x61, 0x6d, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x70, 0x63, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
	0x52, 0x06, 0x6d, 0x69, 0x6e, 0x54, 0x61, 0x6d, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62,
...
var file_filter_proto_goTypes = []any{
	(*Filter)(nil), // 0: pc.Filter
	(*Memory)(nil), // 1: pc.Memory
}
var file_filter_proto_depIdxs = []int32{
	1, // 0: pc.Filter.min_tam:type_name -> pc.Memory
