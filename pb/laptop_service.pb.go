...
type CreateLaptopRequst struct {
...
func (x *CreateLaptopRequst) Reset() {
	*x = CreateLaptopRequst{}
...
func (x *CreateLaptopRequst) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateLaptopRequst) ProtoMessage() {}

func (x *CreateLaptopRequst) ProtoReflect() protoreflect.Message {
	mi := &file_laptop_service_proto_msgTypes[0]
...
// Deprecated: Use CreateLaptopRequst.ProtoReflect.Descriptor instead.
func (*CreateLaptopRequst) Descriptor() ([]byte, []int) {
	return file_laptop_service_proto_rawDescGZIP(), []int{0}
}

func (x *CreateLaptopRequst) GetLaptop() *Laptop {
	if x != nil {
		return x.Laptop
	}
	return nil
...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x38, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x73, 0x74, 0x12, 0x22,
	0x0a, 0x06, 0x6c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a,
	0x2e, 0x70, 0x63, 0x2e, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x06, 0x6c, 0x61, 0x70, 0x74,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0x53, 0x0a, 0x0d, 0x4c, 0x61,
	0x70, 0x74, 0x6f, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x42, 0x0a, 0x0c, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12, 0x16, 0x2e, 0x70, 0x63,
	0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71,
	0x75, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x70, 0x63, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4c,
...
var file_laptop_service_proto_goTypes = []any{
	(*CreateLaptopRequst)(nil),   // 0: pc.CreateLaptopRequst
	(*CreateLaptopResponse)(nil), // 1: pc.CreateLaptopResponse
	(*Laptop)(nil),               // 2: pc.Laptop
}
var file_laptop_service_proto_depIdxs = []int32{
	2, // 0: pc.CreateLaptopRequst.laptop:type_name -> pc.Laptop
	0, // 1: pc.LaptopService.CreateLaptop:input_type -> pc.CreateLaptopRequst
	1, // 2: pc.LaptopService.CreateLaptop:output_type -> pc.CreateLaptopResponse
...
func file_laptop_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_laptop_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*CreateLaptopRequst); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
