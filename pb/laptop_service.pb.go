...
var file_laptop_service_proto_rawDesc = []byte{
	...
	0x68, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x12, 0x17, 0x2e, 0x70, 0x63, 0x2e, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x18, 0x2e, 0x70, 0x63, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4c, 0x61, 0x70, 0x74,
...
var file_laptop_service_proto_goTypes = []any{
	...
	(*Laptop)(nil),               // 4: pc.Laptop
	(*Filter)(nil),               // 5: pc.Filter
}
var file_laptop_service_proto_depIdxs = []int32{
	4, // 0: pc.CreateLaptopRequest.laptop:type_name -> pc.Laptop
	5, // 1: pc.SearchLaptopRequest.filter:type_name -> pc.Filter
	4, // 2: pc.SearchLaptopResponse.laptop:type_name -> pc.Laptop
	0, // 3: pc.LaptopService.CreateLaptop:input_type -> pc.CreateLaptopRequest
	2, // 4: pc.LaptopService.SearchLaptop:input_type -> pc.SearchLaptopRequest
	1, // 5: pc.LaptopService.CreateLaptop:output_type -> pc.CreateLaptopResponse
	3, // 6: pc.LaptopService.SearchLaptop:output_type -> pc.SearchLaptopResponse
