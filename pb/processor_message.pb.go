...
type CPU struct {
	...
	MaxGhx  float64 `protobuf:"fixed64,6,opt,name=max_ghx,json=maxGhx,proto3" json:"max_ghx,omitempty"`
}
...
type GPU struct {
	...
	MaxGhx float64 `protobuf:"fixed64,4,opt,name=max_ghx,json=maxGhx,proto3" json:"max_ghx,omitempty"`
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x63, 0x1a, 0x0c, 0x6d,
	0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x01, 0x0a, 0x03,
	...
	0x72, 0x65, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x74, 0x68, 0x72, 0x65, 0x61, 0x64, 0x73, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x74, 0x68, 0x72, 0x65, 0x61, 0x64, 0x73, 0x12, 0x17, 0x0a,
	...
	0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x6d, 0x61, 0x78, 0x47, 0x68, 0x78, 0x22,
	...
	0x78, 0x5f, 0x67, 0x68, 0x78, 0x18, 0x04, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x6d, 0x61, 0x78,
	0x47, 0x68, 0x78, 0x12, 0x22, 0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x70, 0x63, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52,
	0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62,
...
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: pc.GPU.memory:type_name -> pc.Memory
...
func file_processor_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_processor_message_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*CPU); i {
			case 0:
				return &v.state
			case 1:
		...
		file_processor_message_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*GPU); i {
			case 0:
				return &v.state
			case 1:
