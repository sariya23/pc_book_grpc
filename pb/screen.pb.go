...
type Screen struct {
	...
	Inch       float64            `protobuf:"fixed64,1,opt,name=inch,proto3" json:"inch,omitempty"`
...
var file_screen_proto_rawDesc = []byte{
	...
	0x70, 0x63, 0x22, 0x80, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x12, 0x12, 0x0a,
	0x04, 0x69, 0x6e, 0x63, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x04, 0x69, 0x6e, 0x63,
	0x68, 0x12, 0x35, 0x0a, 0x0a, 0x72, 0x65, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x70, 0x63, 0x2e, 0x53, 0x63, 0x72, 0x65, 0x65,
	0x6e, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0a, 0x72, 0x65,
	0x73, 0x6f, 0x6c, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x26, 0x0a, 0x05, 0x70, 0x61, 0x6e, 0x65,
	0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x70, 0x63, 0x2e, 0x53, 0x63, 0x72,
	...
	0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70,
...
var file_screen_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: pc.Screen.Panel
	(*Screen)(nil),            // 1: pc.Screen
	(*Screen_Resolution)(nil), // 2: pc.Screen.Resolution
}
var file_screen_proto_depIdxs = []int32{
	2, // 0: pc.Screen.resolution:type_name -> pc.Screen.Resolution
	0, // 1: pc.Screen.panel:type_name -> pc.Screen.Panel
...
func file_screen_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_screen_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Screen); i {
			case 0:
				return &v.state
			case 1:
		...
		file_screen_proto_msgTypes[1].Exporter = func(v any, i int) any {
