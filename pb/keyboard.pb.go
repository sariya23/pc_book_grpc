...
var file_keyboard_proto_rawDesc = []byte{
	...
	0x12, 0x02, 0x70, 0x63, 0x22, 0x8e, 0x01, 0x0a, 0x08, 0x4b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72,
	0x64, 0x12, 0x2b, 0x0a, 0x06, 0x6c, 0x61, 0x79, 0x6f, 0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x13, 0x2e, 0x70, 0x63, 0x2e, 0x4b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e,
	...
	0x52, 0x08, 0x62, 0x61, 0x63, 0x6b, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x39, 0x0a, 0x06, 0x4c, 0x61,
...
var file_keyboard_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: pc.Keyboard.Layout
	(*Keyboard)(nil),     // 1: pc.Keyboard
}
var file_keyboard_proto_depIdxs = []int32{
	0, // 0: pc.Keyboard.layout:type_name -> pc.Keyboard.Layout
...
func file_keyboard_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_keyboard_proto_msgTypes[0].Exporter = func(v any, i int) any {
